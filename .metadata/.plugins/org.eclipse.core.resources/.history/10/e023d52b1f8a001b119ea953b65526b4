 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.TransitionImpl#getLinks <em>Links</em>}</li>
...
public class TransitionImpl extends PetriElementImpl implements Transition {
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, PetrinetPackage.TRANSITION__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.TRANSITION__LINKS:
