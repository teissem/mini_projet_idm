...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRessourceNeededAccess().getGroup(), "rule__RessourceNeeded__Group__0");
			...
			builder.put(grammarAccess.getRessourceNeededAccess().getWdAssignment_1(), "rule__RessourceNeeded__WdAssignment_1");
			builder.put(grammarAccess.getRessourceNeededAccess().getReAssignment_4(), "rule__RessourceNeeded__ReAssignment_4");
