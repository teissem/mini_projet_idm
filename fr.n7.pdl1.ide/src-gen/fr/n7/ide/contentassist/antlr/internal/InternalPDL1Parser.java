...
public class InternalPDL1Parser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_INT", "RULE_ID", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'s2s'", "'f2s'", "'s2f'", "'f2f'", "'process'", "'{'", "'}'", "'wd'", "'ws'", "'from'", "'to'", "'re'", "'ren'", "'need'", "'note'"
    };
    ...
    // $ANTLR start "entryRuleRessourceNeeded"
    // InternalPDL1.g:178:1: entryRuleRessourceNeeded : ruleRessourceNeeded EOF ;
    public final void entryRuleRessourceNeeded() throws RecognitionException {
        try {
            // InternalPDL1.g:179:1: ( ruleRessourceNeeded EOF )
            // InternalPDL1.g:180:1: ruleRessourceNeeded EOF
            {
             before(grammarAccess.getRessourceNeededRule()); 
            pushFollow(FOLLOW_1);
            ruleRessourceNeeded();

            state._fsp--;

             after(grammarAccess.getRessourceNeededRule()); 
            match(input,EOF,FOLLOW_2); 
    ...
    // $ANTLR end "entryRuleRessourceNeeded"


    // $ANTLR start "ruleRessourceNeeded"
    // InternalPDL1.g:187:1: ruleRessourceNeeded : ( ( rule__RessourceNeeded__Group__0 ) ) ;
    public final void ruleRessourceNeeded() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:191:2: ( ( ( rule__RessourceNeeded__Group__0 ) ) )
            // InternalPDL1.g:192:2: ( ( rule__RessourceNeeded__Group__0 ) )
            {
            // InternalPDL1.g:192:2: ( ( rule__RessourceNeeded__Group__0 ) )
            // InternalPDL1.g:193:3: ( rule__RessourceNeeded__Group__0 )
            {
             before(grammarAccess.getRessourceNeededAccess().getGroup()); 
            // InternalPDL1.g:194:3: ( rule__RessourceNeeded__Group__0 )
            // InternalPDL1.g:194:4: rule__RessourceNeeded__Group__0
            {
            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__0();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getRessourceNeededAccess().getGroup()); 
    ...
    // InternalPDL1.g:243:1: rule__ProcessElement__Alternatives : ( ( ruleWorkDefinition ) | ( ruleWorkSequence ) | ( ruleGuidance ) | ( ruleRessource ) | ( ruleRessourceNeeded ) );
    public final void rule__ProcessElement__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:247:1: ( ( ruleWorkDefinition ) | ( ruleWorkSequence ) | ( ruleGuidance ) | ( ruleRessource ) | ( ruleRessourceNeeded ) )
            int alt1=5;
            switch ( input.LA(1) ) {
            case 18:
                {
            ...
            switch (alt1) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalPDL1.g:272:2: ( ruleRessourceNeeded )
                    {
                    // InternalPDL1.g:272:2: ( ruleRessourceNeeded )
                    // InternalPDL1.g:273:3: ruleRessourceNeeded
                    {
                     before(grammarAccess.getProcessElementAccess().getRessourceNeededParserRuleCall_4()); 
                    pushFollow(FOLLOW_2);
                    ruleRessourceNeeded();

                    state._fsp--;

                     after(grammarAccess.getProcessElementAccess().getRessourceNeededParserRuleCall_4()); 
    ...
    // InternalPDL1.g:666:1: rule__Ressource__Group__0 : rule__Ressource__Group__0__Impl rule__Ressource__Group__1 ;
    public final void rule__Ressource__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:670:1: ( rule__Ressource__Group__0__Impl rule__Ressource__Group__1 )
            // InternalPDL1.g:671:2: rule__Ressource__Group__0__Impl rule__Ressource__Group__1
            {
            pushFollow(FOLLOW_3);
    ...
    // InternalPDL1.g:678:1: rule__Ressource__Group__0__Impl : ( 're' ) ;
    public final void rule__Ressource__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:682:1: ( ( 're' ) )
            // InternalPDL1.g:683:1: ( 're' )
            {
            // InternalPDL1.g:683:1: ( 're' )
            // InternalPDL1.g:684:2: 're'
            {
    ...
    // InternalPDL1.g:693:1: rule__Ressource__Group__1 : rule__Ressource__Group__1__Impl rule__Ressource__Group__2 ;
    public final void rule__Ressource__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:697:1: ( rule__Ressource__Group__1__Impl rule__Ressource__Group__2 )
            // InternalPDL1.g:698:2: rule__Ressource__Group__1__Impl rule__Ressource__Group__2
            {
    ...
    // InternalPDL1.g:705:1: rule__Ressource__Group__1__Impl : ( ( rule__Ressource__NameAssignment_1 ) ) ;
    public final void rule__Ressource__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:709:1: ( ( ( rule__Ressource__NameAssignment_1 ) ) )
            // InternalPDL1.g:710:1: ( ( rule__Ressource__NameAssignment_1 ) )
            {
            // InternalPDL1.g:710:1: ( ( rule__Ressource__NameAssignment_1 ) )
            // InternalPDL1.g:711:2: ( rule__Ressource__NameAssignment_1 )
            {
             before(grammarAccess.getRessourceAccess().getNameAssignment_1()); 
            // InternalPDL1.g:712:2: ( rule__Ressource__NameAssignment_1 )
            // InternalPDL1.g:712:3: rule__Ressource__NameAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalPDL1.g:720:1: rule__Ressource__Group__2 : rule__Ressource__Group__2__Impl ;
    public final void rule__Ressource__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:724:1: ( rule__Ressource__Group__2__Impl )
            // InternalPDL1.g:725:2: rule__Ressource__Group__2__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalPDL1.g:731:1: rule__Ressource__Group__2__Impl : ( RULE_INT ) ;
    public final void rule__Ressource__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:735:1: ( ( RULE_INT ) )
            // InternalPDL1.g:736:1: ( RULE_INT )
            {
            // InternalPDL1.g:736:1: ( RULE_INT )
            // InternalPDL1.g:737:2: RULE_INT
            {
             before(grammarAccess.getRessourceAccess().getINTTerminalRuleCall_2()); 
            match(input,RULE_INT,FOLLOW_2); 
             after(grammarAccess.getRessourceAccess().getINTTerminalRuleCall_2()); 
    ...
    // $ANTLR start "rule__RessourceNeeded__Group__0"
    // InternalPDL1.g:747:1: rule__RessourceNeeded__Group__0 : rule__RessourceNeeded__Group__0__Impl rule__RessourceNeeded__Group__1 ;
    public final void rule__RessourceNeeded__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:751:1: ( rule__RessourceNeeded__Group__0__Impl rule__RessourceNeeded__Group__1 )
            // InternalPDL1.g:752:2: rule__RessourceNeeded__Group__0__Impl rule__RessourceNeeded__Group__1
            {
            pushFollow(FOLLOW_3);
            rule__RessourceNeeded__Group__0__Impl();

            state._fsp--;

            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__1();
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__0"


    // $ANTLR start "rule__RessourceNeeded__Group__0__Impl"
    // InternalPDL1.g:759:1: rule__RessourceNeeded__Group__0__Impl : ( 'ren' ) ;
    public final void rule__RessourceNeeded__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:763:1: ( ( 'ren' ) )
            // InternalPDL1.g:764:1: ( 'ren' )
            {
            // InternalPDL1.g:764:1: ( 'ren' )
            // InternalPDL1.g:765:2: 'ren'
            {
             before(grammarAccess.getRessourceNeededAccess().getRenKeyword_0()); 
            match(input,23,FOLLOW_2); 
             after(grammarAccess.getRessourceNeededAccess().getRenKeyword_0()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__0__Impl"


    // $ANTLR start "rule__RessourceNeeded__Group__1"
    // InternalPDL1.g:774:1: rule__RessourceNeeded__Group__1 : rule__RessourceNeeded__Group__1__Impl rule__RessourceNeeded__Group__2 ;
    public final void rule__RessourceNeeded__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:778:1: ( rule__RessourceNeeded__Group__1__Impl rule__RessourceNeeded__Group__2 )
            // InternalPDL1.g:779:2: rule__RessourceNeeded__Group__1__Impl rule__RessourceNeeded__Group__2
            {
            pushFollow(FOLLOW_11);
            rule__RessourceNeeded__Group__1__Impl();

            state._fsp--;

            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__2();
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__1"


    // $ANTLR start "rule__RessourceNeeded__Group__1__Impl"
    // InternalPDL1.g:786:1: rule__RessourceNeeded__Group__1__Impl : ( ( rule__RessourceNeeded__WdAssignment_1 ) ) ;
    public final void rule__RessourceNeeded__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:790:1: ( ( ( rule__RessourceNeeded__WdAssignment_1 ) ) )
            // InternalPDL1.g:791:1: ( ( rule__RessourceNeeded__WdAssignment_1 ) )
            {
            // InternalPDL1.g:791:1: ( ( rule__RessourceNeeded__WdAssignment_1 ) )
            // InternalPDL1.g:792:2: ( rule__RessourceNeeded__WdAssignment_1 )
            {
             before(grammarAccess.getRessourceNeededAccess().getWdAssignment_1()); 
            // InternalPDL1.g:793:2: ( rule__RessourceNeeded__WdAssignment_1 )
            // InternalPDL1.g:793:3: rule__RessourceNeeded__WdAssignment_1
            {
            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__WdAssignment_1();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getRessourceNeededAccess().getWdAssignment_1()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__1__Impl"


    // $ANTLR start "rule__RessourceNeeded__Group__2"
    // InternalPDL1.g:801:1: rule__RessourceNeeded__Group__2 : rule__RessourceNeeded__Group__2__Impl rule__RessourceNeeded__Group__3 ;
    public final void rule__RessourceNeeded__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:805:1: ( rule__RessourceNeeded__Group__2__Impl rule__RessourceNeeded__Group__3 )
            // InternalPDL1.g:806:2: rule__RessourceNeeded__Group__2__Impl rule__RessourceNeeded__Group__3
            {
            pushFollow(FOLLOW_10);
            rule__RessourceNeeded__Group__2__Impl();

            state._fsp--;

            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__3();
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__2"


    // $ANTLR start "rule__RessourceNeeded__Group__2__Impl"
    // InternalPDL1.g:813:1: rule__RessourceNeeded__Group__2__Impl : ( 'need' ) ;
    public final void rule__RessourceNeeded__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:817:1: ( ( 'need' ) )
            // InternalPDL1.g:818:1: ( 'need' )
            {
            // InternalPDL1.g:818:1: ( 'need' )
            // InternalPDL1.g:819:2: 'need'
            {
             before(grammarAccess.getRessourceNeededAccess().getNeedKeyword_2()); 
            match(input,24,FOLLOW_2); 
             after(grammarAccess.getRessourceNeededAccess().getNeedKeyword_2()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__2__Impl"


    // $ANTLR start "rule__RessourceNeeded__Group__3"
    // InternalPDL1.g:828:1: rule__RessourceNeeded__Group__3 : rule__RessourceNeeded__Group__3__Impl rule__RessourceNeeded__Group__4 ;
    public final void rule__RessourceNeeded__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:832:1: ( rule__RessourceNeeded__Group__3__Impl rule__RessourceNeeded__Group__4 )
            // InternalPDL1.g:833:2: rule__RessourceNeeded__Group__3__Impl rule__RessourceNeeded__Group__4
            {
            pushFollow(FOLLOW_3);
            rule__RessourceNeeded__Group__3__Impl();

            state._fsp--;

            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__4();
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__3"


    // $ANTLR start "rule__RessourceNeeded__Group__3__Impl"
    // InternalPDL1.g:840:1: rule__RessourceNeeded__Group__3__Impl : ( RULE_INT ) ;
    public final void rule__RessourceNeeded__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:844:1: ( ( RULE_INT ) )
            // InternalPDL1.g:845:1: ( RULE_INT )
            {
            // InternalPDL1.g:845:1: ( RULE_INT )
            // InternalPDL1.g:846:2: RULE_INT
            {
             before(grammarAccess.getRessourceNeededAccess().getINTTerminalRuleCall_3()); 
            match(input,RULE_INT,FOLLOW_2); 
             after(grammarAccess.getRessourceNeededAccess().getINTTerminalRuleCall_3()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__3__Impl"


    // $ANTLR start "rule__RessourceNeeded__Group__4"
    // InternalPDL1.g:855:1: rule__RessourceNeeded__Group__4 : rule__RessourceNeeded__Group__4__Impl ;
    public final void rule__RessourceNeeded__Group__4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:859:1: ( rule__RessourceNeeded__Group__4__Impl )
            // InternalPDL1.g:860:2: rule__RessourceNeeded__Group__4__Impl
            {
            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__Group__4__Impl();
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__4"


    // $ANTLR start "rule__RessourceNeeded__Group__4__Impl"
    // InternalPDL1.g:866:1: rule__RessourceNeeded__Group__4__Impl : ( ( rule__RessourceNeeded__ReAssignment_4 ) ) ;
    public final void rule__RessourceNeeded__Group__4__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:870:1: ( ( ( rule__RessourceNeeded__ReAssignment_4 ) ) )
            // InternalPDL1.g:871:1: ( ( rule__RessourceNeeded__ReAssignment_4 ) )
            {
            // InternalPDL1.g:871:1: ( ( rule__RessourceNeeded__ReAssignment_4 ) )
            // InternalPDL1.g:872:2: ( rule__RessourceNeeded__ReAssignment_4 )
            {
             before(grammarAccess.getRessourceNeededAccess().getReAssignment_4()); 
            // InternalPDL1.g:873:2: ( rule__RessourceNeeded__ReAssignment_4 )
            // InternalPDL1.g:873:3: rule__RessourceNeeded__ReAssignment_4
            {
            pushFollow(FOLLOW_2);
            rule__RessourceNeeded__ReAssignment_4();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getRessourceNeededAccess().getReAssignment_4()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__Group__4__Impl"


    // $ANTLR start "rule__Guidance__Group__0"
    // InternalPDL1.g:882:1: rule__Guidance__Group__0 : rule__Guidance__Group__0__Impl rule__Guidance__Group__1 ;
    public final void rule__Guidance__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:886:1: ( rule__Guidance__Group__0__Impl rule__Guidance__Group__1 )
            // InternalPDL1.g:887:2: rule__Guidance__Group__0__Impl rule__Guidance__Group__1
            {
    ...
    // InternalPDL1.g:894:1: rule__Guidance__Group__0__Impl : ( 'note' ) ;
    public final void rule__Guidance__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:898:1: ( ( 'note' ) )
            // InternalPDL1.g:899:1: ( 'note' )
            {
            // InternalPDL1.g:899:1: ( 'note' )
            // InternalPDL1.g:900:2: 'note'
            {
    ...
    // InternalPDL1.g:909:1: rule__Guidance__Group__1 : rule__Guidance__Group__1__Impl ;
    public final void rule__Guidance__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:913:1: ( rule__Guidance__Group__1__Impl )
            // InternalPDL1.g:914:2: rule__Guidance__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalPDL1.g:920:1: rule__Guidance__Group__1__Impl : ( ( rule__Guidance__TexteAssignment_1 ) ) ;
    public final void rule__Guidance__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:924:1: ( ( ( rule__Guidance__TexteAssignment_1 ) ) )
            // InternalPDL1.g:925:1: ( ( rule__Guidance__TexteAssignment_1 ) )
            {
            // InternalPDL1.g:925:1: ( ( rule__Guidance__TexteAssignment_1 ) )
            // InternalPDL1.g:926:2: ( rule__Guidance__TexteAssignment_1 )
            {
             before(grammarAccess.getGuidanceAccess().getTexteAssignment_1()); 
            // InternalPDL1.g:927:2: ( rule__Guidance__TexteAssignment_1 )
            // InternalPDL1.g:927:3: rule__Guidance__TexteAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalPDL1.g:936:1: rule__Process__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Process__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:940:1: ( ( RULE_ID ) )
            // InternalPDL1.g:941:2: ( RULE_ID )
            {
            // InternalPDL1.g:941:2: ( RULE_ID )
            // InternalPDL1.g:942:3: RULE_ID
            {
    ...
    // InternalPDL1.g:951:1: rule__Process__ProcessElementsAssignment_3 : ( ruleProcessElement ) ;
    public final void rule__Process__ProcessElementsAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:955:1: ( ( ruleProcessElement ) )
            // InternalPDL1.g:956:2: ( ruleProcessElement )
            {
            // InternalPDL1.g:956:2: ( ruleProcessElement )
            // InternalPDL1.g:957:3: ruleProcessElement
            {
    ...
    // InternalPDL1.g:966:1: rule__WorkDefinition__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__WorkDefinition__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:970:1: ( ( RULE_ID ) )
            // InternalPDL1.g:971:2: ( RULE_ID )
            {
            // InternalPDL1.g:971:2: ( RULE_ID )
            // InternalPDL1.g:972:3: RULE_ID
            {
    ...
    // InternalPDL1.g:981:1: rule__WorkSequence__LinkTypeAssignment_1 : ( ruleWorkSequenceType ) ;
    public final void rule__WorkSequence__LinkTypeAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:985:1: ( ( ruleWorkSequenceType ) )
            // InternalPDL1.g:986:2: ( ruleWorkSequenceType )
            {
            // InternalPDL1.g:986:2: ( ruleWorkSequenceType )
            // InternalPDL1.g:987:3: ruleWorkSequenceType
            {
    ...
    // InternalPDL1.g:996:1: rule__WorkSequence__PredecessorAssignment_3 : ( ( RULE_ID ) ) ;
    public final void rule__WorkSequence__PredecessorAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:1000:1: ( ( ( RULE_ID ) ) )
            // InternalPDL1.g:1001:2: ( ( RULE_ID ) )
            {
            // InternalPDL1.g:1001:2: ( ( RULE_ID ) )
            // InternalPDL1.g:1002:3: ( RULE_ID )
            {
             before(grammarAccess.getWorkSequenceAccess().getPredecessorWorkDefinitionCrossReference_3_0()); 
            // InternalPDL1.g:1003:3: ( RULE_ID )
            // InternalPDL1.g:1004:4: RULE_ID
            {
    ...
    // InternalPDL1.g:1015:1: rule__WorkSequence__SuccessorAssignment_5 : ( ( RULE_ID ) ) ;
    public final void rule__WorkSequence__SuccessorAssignment_5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:1019:1: ( ( ( RULE_ID ) ) )
            // InternalPDL1.g:1020:2: ( ( RULE_ID ) )
            {
            // InternalPDL1.g:1020:2: ( ( RULE_ID ) )
            // InternalPDL1.g:1021:3: ( RULE_ID )
            {
             before(grammarAccess.getWorkSequenceAccess().getSuccessorWorkDefinitionCrossReference_5_0()); 
            // InternalPDL1.g:1022:3: ( RULE_ID )
            // InternalPDL1.g:1023:4: RULE_ID
            {
    ...
    // InternalPDL1.g:1034:1: rule__Ressource__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Ressource__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:1038:1: ( ( RULE_ID ) )
            // InternalPDL1.g:1039:2: ( RULE_ID )
            {
            // InternalPDL1.g:1039:2: ( RULE_ID )
            // InternalPDL1.g:1040:3: RULE_ID
            {
    ...
    // $ANTLR start "rule__RessourceNeeded__WdAssignment_1"
    // InternalPDL1.g:1049:1: rule__RessourceNeeded__WdAssignment_1 : ( ( RULE_ID ) ) ;
    public final void rule__RessourceNeeded__WdAssignment_1() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionCrossReference_1_0()); 
            // InternalPDL1.g:1056:3: ( RULE_ID )
            // InternalPDL1.g:1057:4: RULE_ID
            {
             before(grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionIDTerminalRuleCall_1_0_1()); 
            match(input,RULE_ID,FOLLOW_2); 
             after(grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionIDTerminalRuleCall_1_0_1()); 

            }

             after(grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionCrossReference_1_0()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__WdAssignment_1"


    // $ANTLR start "rule__RessourceNeeded__ReAssignment_4"
    // InternalPDL1.g:1068:1: rule__RessourceNeeded__ReAssignment_4 : ( ( RULE_ID ) ) ;
    public final void rule__RessourceNeeded__ReAssignment_4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:1072:1: ( ( ( RULE_ID ) ) )
            // InternalPDL1.g:1073:2: ( ( RULE_ID ) )
            {
            // InternalPDL1.g:1073:2: ( ( RULE_ID ) )
            // InternalPDL1.g:1074:3: ( RULE_ID )
            {
             before(grammarAccess.getRessourceNeededAccess().getReRessourceCrossReference_4_0()); 
            // InternalPDL1.g:1075:3: ( RULE_ID )
            // InternalPDL1.g:1076:4: RULE_ID
            {
             before(grammarAccess.getRessourceNeededAccess().getReRessourceIDTerminalRuleCall_4_0_1()); 
            match(input,RULE_ID,FOLLOW_2); 
             after(grammarAccess.getRessourceNeededAccess().getReRessourceIDTerminalRuleCall_4_0_1()); 

            }

             after(grammarAccess.getRessourceNeededAccess().getReRessourceCrossReference_4_0()); 
    ...
    // $ANTLR end "rule__RessourceNeeded__ReAssignment_4"


    // $ANTLR start "rule__Guidance__TexteAssignment_1"
    // InternalPDL1.g:1087:1: rule__Guidance__TexteAssignment_1 : ( RULE_STRING ) ;
    public final void rule__Guidance__TexteAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL1.g:1091:1: ( ( RULE_STRING ) )
            // InternalPDL1.g:1092:2: ( RULE_STRING )
            {
            // InternalPDL1.g:1092:2: ( RULE_STRING )
            // InternalPDL1.g:1093:3: RULE_STRING
            {
