...
public interface PDL1Package extends EPackage
{
   ...
   * @ordered
   */
  int RESSOURCE_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.RessourceNeededImpl <em>Ressource Needed</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.RessourceNeededImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceNeeded()
   * @generated
   */
  int RESSOURCE_NEEDED = 5;
   ...
   * @ordered
   */
  int RESSOURCE_NEEDED__WD = PROCESS_ELEMENT_FEATURE_COUNT + 0;

  /**
   * The feature id for the '<em><b>Re</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int RESSOURCE_NEEDED__RE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.RessourceNeeded <em>Ressource Needed</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Ressource Needed</em>'.
   * @see fr.n7.pDL1.RessourceNeeded
   * @generated
   */
  EClass getRessourceNeeded();

  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.RessourceNeeded#getWd <em>Wd</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Wd</em>'.
   * @see fr.n7.pDL1.RessourceNeeded#getWd()
   * @see #getRessourceNeeded()
   * @generated
   */
  EReference getRessourceNeeded_Wd();

  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.RessourceNeeded#getRe <em>Re</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Re</em>'.
   * @see fr.n7.pDL1.RessourceNeeded#getRe()
   * @see #getRessourceNeeded()
   * @generated
   */
  EReference getRessourceNeeded_Re();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.RessourceNeededImpl <em>Ressource Needed</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.RessourceNeededImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceNeeded()
     ...
     * @generated
     */
    EReference RESSOURCE_NEEDED__WD = eINSTANCE.getRessourceNeeded_Wd();

    /**
     * The meta object literal for the '<em><b>Re</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference RESSOURCE_NEEDED__RE = eINSTANCE.getRessourceNeeded_Re();
