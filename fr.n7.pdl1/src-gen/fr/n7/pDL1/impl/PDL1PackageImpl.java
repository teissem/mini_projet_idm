...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   */
  @Override
  public EReference getRessourceNeeded_Wd()
  {
    return (EReference)ressourceNeededEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getRessourceNeeded_Re()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(ressourceNeededEClass, RESSOURCE_NEEDED__WD);
    createEReference(ressourceNeededEClass, RESSOURCE_NEEDED__RE);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getRessourceNeeded_Wd(), this.getWorkDefinition(), null, "wd", null, 0, 1, RessourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRessourceNeeded_Re(), this.getRessource(), null, "re", null, 0, 1, RessourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
