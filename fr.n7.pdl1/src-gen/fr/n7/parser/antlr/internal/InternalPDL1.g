...
@after {
	...
	(
		...
		{
			$current = $this_RessourceNeeded_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRessourceNeeded returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRessourceNeededRule()); }
	iv_ruleRessourceNeeded=ruleRessourceNeeded
	{ $current=$iv_ruleRessourceNeeded.current; }
	EOF;

// Rule RessourceNeeded
ruleRessourceNeeded returns [EObject current=null]
@init {
	enterRule();
}
@after {
