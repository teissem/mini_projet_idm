...
public class InternalPDL1Parser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'process'", "'{'", "'}'", "'wd'", "'ws'", "'from'", "'to'", "'re'", "'ren'", "'need'", "'note'", "'s2s'", "'f2s'", "'s2f'", "'f2f'"
    };
    ...
    // InternalPDL1.g:140:1: ruleProcessElement returns [EObject current=null] : (this_WorkDefinition_0= ruleWorkDefinition | this_WorkSequence_1= ruleWorkSequence | this_Guidance_2= ruleGuidance | this_Ressource_3= ruleRessource | this_RessourceNeeded_4= ruleRessourceNeeded ) ;
    public final EObject ruleProcessElement() throws RecognitionException {
        ...
        EObject this_RessourceNeeded_4 = null;
        ...
        try {
            // InternalPDL1.g:146:2: ( (this_WorkDefinition_0= ruleWorkDefinition | this_WorkSequence_1= ruleWorkSequence | this_Guidance_2= ruleGuidance | this_Ressource_3= ruleRessource | this_RessourceNeeded_4= ruleRessourceNeeded ) )
            // InternalPDL1.g:147:2: (this_WorkDefinition_0= ruleWorkDefinition | this_WorkSequence_1= ruleWorkSequence | this_Guidance_2= ruleGuidance | this_Ressource_3= ruleRessource | this_RessourceNeeded_4= ruleRessourceNeeded )
            {
            // InternalPDL1.g:147:2: (this_WorkDefinition_0= ruleWorkDefinition | this_WorkSequence_1= ruleWorkSequence | this_Guidance_2= ruleGuidance | this_Ressource_3= ruleRessource | this_RessourceNeeded_4= ruleRessourceNeeded )
            int alt2=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt2) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalPDL1.g:184:3: this_RessourceNeeded_4= ruleRessourceNeeded
                    {

                    			newCompositeNode(grammarAccess.getProcessElementAccess().getRessourceNeededParserRuleCall_4());
                    		
                    pushFollow(FOLLOW_2);
                    this_RessourceNeeded_4=ruleRessourceNeeded();

                    state._fsp--;


                    			current = this_RessourceNeeded_4;
                    			afterParserOrEnumRuleCall();
    ...
    // InternalPDL1.g:313:1: entryRuleRessource returns [EObject current=null] : iv_ruleRessource= ruleRessource EOF ;
    public final EObject entryRuleRessource() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:313:50: (iv_ruleRessource= ruleRessource EOF )
            // InternalPDL1.g:314:2: iv_ruleRessource= ruleRessource EOF
            {
    ...
    // InternalPDL1.g:320:1: ruleRessource returns [EObject current=null] : (otherlv_0= 're' ( (lv_name_1_0= RULE_ID ) ) this_INT_2= RULE_INT ) ;
    public final EObject ruleRessource() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:326:2: ( (otherlv_0= 're' ( (lv_name_1_0= RULE_ID ) ) this_INT_2= RULE_INT ) )
            // InternalPDL1.g:327:2: (otherlv_0= 're' ( (lv_name_1_0= RULE_ID ) ) this_INT_2= RULE_INT )
            {
            // InternalPDL1.g:327:2: (otherlv_0= 're' ( (lv_name_1_0= RULE_ID ) ) this_INT_2= RULE_INT )
            // InternalPDL1.g:328:3: otherlv_0= 're' ( (lv_name_1_0= RULE_ID ) ) this_INT_2= RULE_INT
            {
            otherlv_0=(Token)match(input,18,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getRessourceAccess().getReKeyword_0());
            		
            // InternalPDL1.g:332:3: ( (lv_name_1_0= RULE_ID ) )
            // InternalPDL1.g:333:4: (lv_name_1_0= RULE_ID )
            {
            // InternalPDL1.g:333:4: (lv_name_1_0= RULE_ID )
            // InternalPDL1.g:334:5: lv_name_1_0= RULE_ID
            {
            ...
            this_INT_2=(Token)match(input,RULE_INT,FOLLOW_2); 
            			...
            			newLeafNode(this_INT_2, grammarAccess.getRessourceAccess().getINTTerminalRuleCall_2());
    ...
    // InternalPDL1.g:358:1: entryRuleRessourceNeeded returns [EObject current=null] : iv_ruleRessourceNeeded= ruleRessourceNeeded EOF ;
    public final EObject entryRuleRessourceNeeded() throws RecognitionException {
        EObject current = null;

        EObject iv_ruleRessourceNeeded = null;


        try {
            // InternalPDL1.g:358:56: (iv_ruleRessourceNeeded= ruleRessourceNeeded EOF )
            // InternalPDL1.g:359:2: iv_ruleRessourceNeeded= ruleRessourceNeeded EOF
            {
             newCompositeNode(grammarAccess.getRessourceNeededRule()); 
            pushFollow(FOLLOW_1);
            iv_ruleRessourceNeeded=ruleRessourceNeeded();

            state._fsp--;

             current =iv_ruleRessourceNeeded; 
            match(input,EOF,FOLLOW_2); 
    ...
    // InternalPDL1.g:365:1: ruleRessourceNeeded returns [EObject current=null] : (otherlv_0= 'ren' ( (otherlv_1= RULE_ID ) ) otherlv_2= 'need' this_INT_3= RULE_INT ( (otherlv_4= RULE_ID ) ) ) ;
    public final EObject ruleRessourceNeeded() throws RecognitionException {
        EObject current = null;
        ...
        try {
            // InternalPDL1.g:371:2: ( (otherlv_0= 'ren' ( (otherlv_1= RULE_ID ) ) otherlv_2= 'need' this_INT_3= RULE_INT ( (otherlv_4= RULE_ID ) ) ) )
            // InternalPDL1.g:372:2: (otherlv_0= 'ren' ( (otherlv_1= RULE_ID ) ) otherlv_2= 'need' this_INT_3= RULE_INT ( (otherlv_4= RULE_ID ) ) )
            {
            // InternalPDL1.g:372:2: (otherlv_0= 'ren' ( (otherlv_1= RULE_ID ) ) otherlv_2= 'need' this_INT_3= RULE_INT ( (otherlv_4= RULE_ID ) ) )
            // InternalPDL1.g:373:3: otherlv_0= 'ren' ( (otherlv_1= RULE_ID ) ) otherlv_2= 'need' this_INT_3= RULE_INT ( (otherlv_4= RULE_ID ) )
            {
            otherlv_0=(Token)match(input,19,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getRessourceNeededAccess().getRenKeyword_0());
            		
            // InternalPDL1.g:377:3: ( (otherlv_1= RULE_ID ) )
            // InternalPDL1.g:378:4: (otherlv_1= RULE_ID )
            {
            // InternalPDL1.g:378:4: (otherlv_1= RULE_ID )
            // InternalPDL1.g:379:5: otherlv_1= RULE_ID
            {

            					if (current==null) {
            						current = createModelElement(grammarAccess.getRessourceNeededRule());
            					}
            				
            otherlv_1=(Token)match(input,RULE_ID,FOLLOW_10); 

            					newLeafNode(otherlv_1, grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionCrossReference_1_0());
            ...
            otherlv_2=(Token)match(input,20,FOLLOW_9); 
            			...
            			newLeafNode(otherlv_2, grammarAccess.getRessourceNeededAccess().getNeedKeyword_2());
            		
            this_INT_3=(Token)match(input,RULE_INT,FOLLOW_3); 

            			newLeafNode(this_INT_3, grammarAccess.getRessourceNeededAccess().getINTTerminalRuleCall_3());
            		
            // InternalPDL1.g:398:3: ( (otherlv_4= RULE_ID ) )
            // InternalPDL1.g:399:4: (otherlv_4= RULE_ID )
            {
            // InternalPDL1.g:399:4: (otherlv_4= RULE_ID )
            // InternalPDL1.g:400:5: otherlv_4= RULE_ID
            {
            ...
            otherlv_4=(Token)match(input,RULE_ID,FOLLOW_2); 
            					...
            					newLeafNode(otherlv_4, grammarAccess.getRessourceNeededAccess().getReRessourceCrossReference_4_0());
    ...
    // InternalPDL1.g:415:1: entryRuleGuidance returns [EObject current=null] : iv_ruleGuidance= ruleGuidance EOF ;
    public final EObject entryRuleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:415:49: (iv_ruleGuidance= ruleGuidance EOF )
            // InternalPDL1.g:416:2: iv_ruleGuidance= ruleGuidance EOF
            {
    ...
    // InternalPDL1.g:422:1: ruleGuidance returns [EObject current=null] : (otherlv_0= 'note' ( (lv_texte_1_0= RULE_STRING ) ) ) ;
    public final EObject ruleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:428:2: ( (otherlv_0= 'note' ( (lv_texte_1_0= RULE_STRING ) ) ) )
            // InternalPDL1.g:429:2: (otherlv_0= 'note' ( (lv_texte_1_0= RULE_STRING ) ) )
            {
            // InternalPDL1.g:429:2: (otherlv_0= 'note' ( (lv_texte_1_0= RULE_STRING ) ) )
            // InternalPDL1.g:430:3: otherlv_0= 'note' ( (lv_texte_1_0= RULE_STRING ) )
            {
            otherlv_0=(Token)match(input,21,FOLLOW_11); 

            			newLeafNode(otherlv_0, grammarAccess.getGuidanceAccess().getNoteKeyword_0());
            		
            // InternalPDL1.g:434:3: ( (lv_texte_1_0= RULE_STRING ) )
            // InternalPDL1.g:435:4: (lv_texte_1_0= RULE_STRING )
            {
            // InternalPDL1.g:435:4: (lv_texte_1_0= RULE_STRING )
            // InternalPDL1.g:436:5: lv_texte_1_0= RULE_STRING
            {
    ...
    // InternalPDL1.g:456:1: ruleWorkSequenceType returns [Enumerator current=null] : ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) ;
    public final Enumerator ruleWorkSequenceType() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:462:2: ( ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) )
            // InternalPDL1.g:463:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            {
            // InternalPDL1.g:463:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            int alt3=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt3) {
                case 1 :
                    // InternalPDL1.g:464:3: (enumLiteral_0= 's2s' )
                    {
                    // InternalPDL1.g:464:3: (enumLiteral_0= 's2s' )
                    // InternalPDL1.g:465:4: enumLiteral_0= 's2s'
                    {
                    ...
                    break;
                case 2 :
                    // InternalPDL1.g:472:3: (enumLiteral_1= 'f2s' )
                    {
                    // InternalPDL1.g:472:3: (enumLiteral_1= 'f2s' )
                    // InternalPDL1.g:473:4: enumLiteral_1= 'f2s'
                    {
                    ...
                    break;
                case 3 :
                    // InternalPDL1.g:480:3: (enumLiteral_2= 's2f' )
                    {
                    // InternalPDL1.g:480:3: (enumLiteral_2= 's2f' )
                    // InternalPDL1.g:481:4: enumLiteral_2= 's2f'
                    {
                    ...
                    break;
                case 4 :
                    // InternalPDL1.g:488:3: (enumLiteral_3= 'f2f' )
                    {
                    // InternalPDL1.g:488:3: (enumLiteral_3= 'f2f' )
                    // InternalPDL1.g:489:4: enumLiteral_3= 'f2f'
                    {
