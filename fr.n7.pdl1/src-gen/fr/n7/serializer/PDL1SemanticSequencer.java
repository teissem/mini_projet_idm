...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.RESSOURCE:
				...
				return; 
			case PDL1Package.RESSOURCE_NEEDED:
				sequence_RessourceNeeded(context, (RessourceNeeded) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     ProcessElement returns RessourceNeeded
	 *     RessourceNeeded returns RessourceNeeded
	 *
	 * Constraint:
	 *     (wd=[WorkDefinition|ID] re=[Ressource|ID])
	 */
	protected void sequence_RessourceNeeded(ISerializationContext context, RessourceNeeded semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_NEEDED__WD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_NEEDED__WD));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_NEEDED__RE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_NEEDED__RE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRessourceNeededAccess().getWdWorkDefinitionIDTerminalRuleCall_1_0_1(), semanticObject.eGet(PDL1Package.Literals.RESSOURCE_NEEDED__WD, false));
		feeder.accept(grammarAccess.getRessourceNeededAccess().getReRessourceIDTerminalRuleCall_4_0_1(), semanticObject.eGet(PDL1Package.Literals.RESSOURCE_NEEDED__RE, false));
		feeder.finish();
	}
