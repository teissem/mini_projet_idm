...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProcessElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRessourceNeededParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		
		//ProcessElement :
		//    WorkDefinition | WorkSequence | Guidance | Ressource | RessourceNeeded;
		@Override public ParserRule getRule() { return rule; }
		...
		//RessourceNeeded
		public RuleCall getRessourceNeededParserRuleCall_4() { return cRessourceNeededParserRuleCall_4; }
	}
	...
	public class RessourceNeededElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.RessourceNeeded");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRenKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cWdAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final CrossReference cWdWorkDefinitionCrossReference_1_0 = (CrossReference)cWdAssignment_1.eContents().get(0);
		private final RuleCall cWdWorkDefinitionIDTerminalRuleCall_1_0_1 = (RuleCall)cWdWorkDefinitionCrossReference_1_0.eContents().get(1);
		private final Keyword cNeedKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final RuleCall cINTTerminalRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		private final Assignment cReAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final CrossReference cReRessourceCrossReference_4_0 = (CrossReference)cReAssignment_4.eContents().get(0);
		private final RuleCall cReRessourceIDTerminalRuleCall_4_0_1 = (RuleCall)cReRessourceCrossReference_4_0.eContents().get(1);
		
		//RessourceNeeded :
		//    'ren' wd=[WorkDefinition] 'need' INT re=[Ressource]
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//'ren'
		public Keyword getRenKeyword_0() { return cRenKeyword_0; }
		
		//wd=[WorkDefinition]
		public Assignment getWdAssignment_1() { return cWdAssignment_1; }
		
		//[WorkDefinition]
		public CrossReference getWdWorkDefinitionCrossReference_1_0() { return cWdWorkDefinitionCrossReference_1_0; }
		
		//ID
		public RuleCall getWdWorkDefinitionIDTerminalRuleCall_1_0_1() { return cWdWorkDefinitionIDTerminalRuleCall_1_0_1; }
		
		//'need'
		public Keyword getNeedKeyword_2() { return cNeedKeyword_2; }
		
		//INT
		public RuleCall getINTTerminalRuleCall_3() { return cINTTerminalRuleCall_3; }
		
		//re=[Ressource]
		public Assignment getReAssignment_4() { return cReAssignment_4; }
		
		//[Ressource]
		public CrossReference getReRessourceCrossReference_4_0() { return cReRessourceCrossReference_4_0; }
		
		//ID
		public RuleCall getReRessourceIDTerminalRuleCall_4_0_1() { return cReRessourceIDTerminalRuleCall_4_0_1; }
	}
	...
	private final RessourceNeededElements pRessourceNeeded;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pRessourceNeeded = new RessourceNeededElements();
	...
	//    'ren' wd=[WorkDefinition] 'need' INT re=[Ressource]
	//;
	public RessourceNeededElements getRessourceNeededAccess() {
		return pRessourceNeeded;
	}
	
	public ParserRule getRessourceNeededRule() {
		return getRessourceNeededAccess().getRule();
	}
