...
public class PDL2Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL2GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRessourceAccess().getGroup_5(), "rule__Ressource__Group_5__0");
			...
			builder.put(grammarAccess.getRessourceAccess().getWdAssignment_5_0(), "rule__Ressource__WdAssignment_5_0");
