...
public class PDL2GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProcessElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRessourceParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//Ressource
		public RuleCall getRessourceParserRuleCall_2() { return cRessourceParserRuleCall_2; }
	}
	...
	public class RessourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL2.Ressource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cWdAssignment_5_0 = (Assignment)cGroup_5.eContents().get(0);
		private final CrossReference cWdWorkDefinitionCrossReference_5_0_0 = (CrossReference)cWdAssignment_5_0.eContents().get(0);
		private final RuleCall cWdWorkDefinitionIDTerminalRuleCall_5_0_0_1 = (RuleCall)cWdWorkDefinitionCrossReference_5_0_0.eContents().get(1);
		private final Keyword cNeedKeyword_5_1 = (Keyword)cGroup_5.eContents().get(1);
		...
		private final Keyword cStartKeyword_5_4 = (Keyword)cGroup_5.eContents().get(4);
		...
		//wd=[WorkDefinition]
		public Assignment getWdAssignment_5_0() { return cWdAssignment_5_0; }
		
		//[WorkDefinition]
		public CrossReference getWdWorkDefinitionCrossReference_5_0_0() { return cWdWorkDefinitionCrossReference_5_0_0; }
		
		//ID
		public RuleCall getWdWorkDefinitionIDTerminalRuleCall_5_0_0_1() { return cWdWorkDefinitionIDTerminalRuleCall_5_0_0_1; }
		
		//'need'
		public Keyword getNeedKeyword_5_1() { return cNeedKeyword_5_1; }
		...
		//'start'
		public Keyword getStartKeyword_5_4() { return cStartKeyword_5_4; }
