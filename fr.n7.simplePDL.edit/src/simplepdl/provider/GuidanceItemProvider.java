	...
	protected void addGuidancesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guidance_guidances_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guidance_guidances_feature", "_UI_Guidance_type"),
				 SimplepdlPackage.Literals.GUIDANCE__GUIDANCES,
				 true,
				 false,
				 true,
				 null,
