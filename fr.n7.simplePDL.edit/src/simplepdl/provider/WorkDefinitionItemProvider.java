	...
	protected void addRessourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_ressources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_ressources_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__RESSOURCES,
				 true,
				 false,
				 true,
				 null,
