...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GUIDANCE__GUIDANCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESSOURCE_NEEDED__QUANTITY = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE_NEEDED__RESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESSOURCE_NEEDED_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESSOURCE_NEEDED_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Guidance#getGuidances <em>Guidances</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Guidances</em>'.
	 * @see simplepdl.Guidance#getGuidances()
	 * @see #getGuidance()
	 * @generated
	 */
	EReference getGuidance_Guidances();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RessourceNeeded#getQuantity <em>Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity</em>'.
	 * @see simplepdl.RessourceNeeded#getQuantity()
	 * @see #getRessourceNeeded()
	 * @generated
	 */
	EAttribute getRessourceNeeded_Quantity();

	/**
	 * Returns the meta object for the containment reference '{@link simplepdl.RessourceNeeded#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference GUIDANCE__GUIDANCES = eINSTANCE.getGuidance_Guidances();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE_NEEDED__QUANTITY = eINSTANCE.getRessourceNeeded_Quantity();
