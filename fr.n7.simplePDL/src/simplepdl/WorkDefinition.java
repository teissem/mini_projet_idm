 ...
 *   <li>{@link simplepdl.WorkDefinition#getRessources <em>Ressources</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	 ...
	 * The list contents are of type {@link simplepdl.RessourceNeeded}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Ressources</em>' reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Ressources()
	 * @model
	 * @generated
	 */
	EList<RessourceNeeded> getRessources();
