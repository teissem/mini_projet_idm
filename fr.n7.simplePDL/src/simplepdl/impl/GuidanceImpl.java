 ...
 *   <li>{@link simplepdl.impl.GuidanceImpl#getGuidances <em>Guidances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuidanceImpl extends ProcessElementImpl implements Guidance {
	 ...
	 * @ordered
	 */
	protected EList<ProcessElement> guidances;
	 ...
	 * @generated
	 */
	public EList<ProcessElement> getGuidances() {
		if (guidances == null) {
			guidances = new EObjectResolvingEList<ProcessElement>(ProcessElement.class, this, SimplepdlPackage.GUIDANCE__GUIDANCES);
		}
		return guidances;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplepdlPackage.GUIDANCE__TEXT:
				return getText();
			case SimplepdlPackage.GUIDANCE__GUIDANCES:
				return getGuidances();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.GUIDANCE__GUIDANCES:
				getGuidances().clear();
				getGuidances().addAll((Collection<? extends ProcessElement>)newValue);
				return;
		}
