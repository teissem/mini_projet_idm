...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EReference getGuidance_Guidances() {
	 ...
	 * @generated
	 */
	public EAttribute getRessourceNeeded_Quantity() {
	...
	public void createPackageContents() {
		...
		createEReference(guidanceEClass, GUIDANCE__GUIDANCES);
		...
		createEAttribute(ressourceNeededEClass, RESSOURCE_NEEDED__QUANTITY);
	...
	public void initializePackageContents() {
		...
		ressourceNeededEClass.getESuperTypes().add(this.getProcessElement());
		...
		initEReference(getWorkDefinition_Ressources(), this.getRessourceNeeded(), null, "ressources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGuidance_Guidances(), this.getProcessElement(), null, "guidances", null, 0, -1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessourceNeeded_Quantity(), ecorePackage.getEInt(), "quantity", null, 1, 1, RessourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourceNeeded_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, RessourceNeeded.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
