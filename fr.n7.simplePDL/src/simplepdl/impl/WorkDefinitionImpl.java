...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<RessourceNeeded> ressources;
	 ...
	 * @generated
	 */
	public EList<RessourceNeeded> getRessources() {
		if (ressources == null) {
			ressources = new EObjectResolvingEList<RessourceNeeded>(RessourceNeeded.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCES);
		}
		return ressources;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES:
				getRessources().clear();
				getRessources().addAll((Collection<? extends RessourceNeeded>)newValue);
				return;
		}
